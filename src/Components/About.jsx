...
const About = () => {
    return (
        ...
        I originally planned to be a chemical engineer, but after doing my second internship, I realized that although it was interesting, this was not something I was ready to dedicate my life to. 
        <br/>
        <br/>
